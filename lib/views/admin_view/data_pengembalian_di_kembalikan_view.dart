              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Obx(() {
                      if (pengembalianC.dataWithStatusDikembalikan.isEmpty) {
                        return Empetystate(
                          title: 'Belum ada Riwayat',
                          subTitle:
                              'Data akan muncul jika ada pengembalian masuk',
                        );
                      }
                      return Padding(
                                    ...
                                    PopupMenuButton(
                                      ...
                                      onSelected: (value) {
                                        if (value == 'edit') {
                                          ...
                                          pengembalianC.showBottomSheetsForReject(data.id ?? '', data);
                                        } else if (value == 'reject') {
                                          pengembalianC.rejectPengembalian(
                                            data.id ?? '',
                                          );
                                        }
                                      },
